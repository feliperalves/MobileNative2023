...
export function CarroScreen() {
  ...
  return (
    <View style={styles.container}>
      <Image source={require("../../assets/estrada.png")} style={styles.fundo} />
...
export function CarroScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      />
      <Text style={styles.text}>Accelerometer: (in gs where 1g = 9.81 m/s^2)</Text>
      <Text style={styles.text}>d: {(Dimensions.get("screen").height / 2).toFixed(4)}</Text>
      <Text style={styles.text}>x: {x.toFixed(4)}</Text>
      <Text style={styles.text}>y: {y.toFixed(4)}</Text>
      <Text style={styles.text}>z: {z.toFixed(4)}</Text>
      <View style={styles.buttonContainer}>
